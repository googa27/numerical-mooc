...
Source of truth: `docs/ARCHITECTURE.yaml`. Tracking: [Project #24](https://github.com/users/googa27/projects/24), [numerical-mooc issue](https://github.com/googa27/arxiv-implementation-lab/issues/23). Profile: `legacy`; enforcement: `Advisory`.
...
- AI: Minimal AGENTS preserving upstream/teaching workflow; no MCP/plugin.
- Human/notebook: Notebook-first educational use; no forced package/dunder redesign.
- Planned Python protocols: No new dunders in the educational upstream fork; preserve notebook pedagogy and upstream compatibility.
- Core posture: No core coupling.
- Data posture: Educational static datasets; upstream policy governs.
